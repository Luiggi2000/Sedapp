<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Menú para Administrador (rol_id == 1) -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('orden-cortes.index')" :active="request()->routeIs('orden-cortes.index')">
                {{ __('Ordenes') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('evidencias.index')" :active="request()->routeIs('evidencias.index')">
                {{ __('Evidencias') }}
            </x-responsive-nav-link>
            ...
            @if (Auth::user()->rol_id == 1)
                ...
                <x-responsive-nav-link :href="route('zonas.index')" :active="request()->routeIs('zonas.index')">
                    {{ __('Zonas') }}
                </x-responsive-nav-link>
            @endif
        </div>
